defmodule SpotOn.AuthControllerTest do
  ...
  describe "authorization" do
    test "authorize call properly redirects to spotify login", %{conn: conn} do
      ...
      assert redirected_to(response, 302) =~ "https://accounts.spotify.com/authorize"
    end
  end
  ...
  describe "authentication" do
    ...
    test "when code provided and Spotify authenticates, authentication succeeds", %{conn: conn} do
      ClientBehaviorMock
